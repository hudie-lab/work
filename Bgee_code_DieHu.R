...
## Here one can not use 'list_bgee_ref_intergenic_species(myBgeeMetadata = bgee, release="community")'
## because 'community' and 'custom'  are not Bgee reference intergenic releases.
